"""
车辆清洗检测 - 本地视频测试版
基于 test_full_video.py 完整逻辑，独立可直接运行
"""
...
# 日志
# ============================================================
log_file = open('video_test.log', 'w', encoding='utf-8')
